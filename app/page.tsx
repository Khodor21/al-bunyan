    ...
    >
      <AnimatePresence mode="wait">
        <motion.img
          ...
          className="absolute w-full max-w-xs object-contain"
        />
      </AnimatePresence>
    </div>
  );
  ...
  return (
    <>
      ...
      >
        ...
        {/* Separated Top Navigation Bar Component */}
        ...
        >
          ...
          {/* Main Action Grid */}
          <div className="grid grid-cols-2 gap-2 w-full mx-auto text-center">
            {[
              {
