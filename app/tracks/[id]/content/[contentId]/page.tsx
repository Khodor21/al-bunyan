...
const ARTICLES_DATA = [
  ...
  // You can add ID 2 here later
  {
    ...
    sections: [
      {
        id: "s1",
        body: `العلمانية منظومة فكرية أو سياسية تدعو إلى إقصاء الدين، أو المرجعية الغيبية، عن الشؤون العامة للدولة، وتسيير الحياة اليومية والسياسية والاقتصادية والتعليمية بناءً على أسس مادية وعقلانية بحتة`,
      },
      {
        id: "s11",
        body: ` أول من صاغ المصطلح الإنجليزي (Secularism) هو الكاتب البريطاني جورج هوليوك (George Holyoake) عام 1851م، وعرّفها بأنها: "نظام يعنى بالمسائل التي يمكن اختبارها بالتجربة والخبرة البشرية في هذه الحياة، دون إنكار الدين أو إثباته، بل باعتباره أمراً ثانوياً غير مؤثر في الفضاء العام`,
      },
      {
        id: "s2",
        body: `أمّا لفظ العلمانية فهو ترجمة خاطئة لكلمة (secularism) في الإنجليزية، أو (secularity) بالفرنسية، وهي كلمة لا صلة لها بلفظ "العلم" ومشتقاته على الإطلاق. فالعلم في الإنجليزية والفرنسية معناه (science)، والمذهب العلمي نطلق عليه (scientism)، والنسبة إلى العلم هي (scientific) أو (scientifique) في الفرنسية.`,
      },
